...
<div class="row">
    <?php foreach ($products as $product) : ?>
        <div class="col-12 col-lg-6 col-xl-4">
            <a href="index.php?url=products&id=<?php echo($product->getId())?>">
            ...
            <div class="row d-none">
                <div class="col-md-2">
                    <a href="index.php?url=products&id=<?php echo($product->getId())?>"><img class="image-product" src=<?= "productimages/".$product->getImage(); ?>></a>
                </div>
                <div class ="col-md-8">
                    <a href="index.php?url=products&id=<?php echo($product->getId())?>"><h1 class="color-white"><?= $product->getName(); ?></h1></a>
