                    ...
                    <div class="card-body p-4">
                            ...
                            <div class="card-body p-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                            ...
                                            <div class="row pb-1">
                                                <div class="col-8">
                                                    <input class="form-control" type="text" value="<?php echo $customer->getAdd1();?>" aria-label="<?php echo $customer->getAdd1();?>" disabled readonly>
                                                </div>
                                            </div>
                                            <div class="row pb-1">
                                                <div class="col-8">
                                                    <input class="form-control" type="text" value="<?php echo $customer->getAdd2();?>" aria-label="<?php echo $customer->getAdd2();?>" disabled readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-2">
                                                    <input class="form-control" type="text" value=<?php echo $customer->getAdd3();?> aria-label="<?php echo $customer->getAdd3();?>" disabled readonly>
                                                </div>
                                                <div class="col-2">
                        ...
                        <div class="card mb-3">
                            ...
                            <h5 class="mb-3">Autres informations de livraison</h5>
                                <div class="row">
                                    <div class="col-1 d-flex justify-content-center">
                                        <input type="radio" name="customer_address" value="1">
                                    </div>
                                    <div class="col">
                                            <div class="row pb-1">
                                                <div class="col-2">
